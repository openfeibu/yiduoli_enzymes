    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'name',title:'<?php echo e(trans('nav.label.name')); ?>',edit:'text'}
                ,{field:'en_name',title:'<?php echo e(trans('nav.label.en_name')); ?>',edit:'text'}
                ,{field:'slug',title:'<?php echo e(trans('nav.label.slug')); ?>',edit:'text'}
                ,{field:'image',title:'<?php echo e(trans('nav.label.image')); ?>', toolbar:'#imageTEM',width:120}
                ,{field:'url',title:'<?php echo e(trans('nav.label.url')); ?>',edit:'text'}
