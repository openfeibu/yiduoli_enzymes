	...
	<div class="headerBg transition500">
        <div class="container w1400">
            <div class="logo newLogo pull-left fadeInUp animated transition500">
                <a href="<?php echo e(route('pc.home',['lang' => 'cn'])); ?>">
                    <h1 hidden=""><?php echo e(setting('station_name')); ?></h1>
                    <img class="logo1 " src="<?php echo e('/image/original'.setting('logo')); ?>" alt="<?php echo e(setting('station_name')); ?>" class="block">
                    <img class="logo2 " src="<?php echo e('/image/original'.setting('logo')); ?>" alt="<?php echo e(setting('station_name')); ?>" class="block">
                </a>
				<div class="companycode"><a target="_blank" href="/href?url=<?php echo urlencode('http://irm.cninfo.com.cn/ircs/company/companyDetail?stockcode=300381&orgId=9900019308'); ?>">股票代码：300381</a></div> 
            </div>
