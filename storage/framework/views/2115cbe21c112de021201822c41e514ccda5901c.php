...
<div class="about">
    <div class="container w1400">
        <div class="about-left col-lg-6 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-duration=".6s" data-wow-delay=".3s">
            <a href="<?php echo e(setting('vr')); ?>" target="_blank">
...
<div class="product">
    <div class="container w1400">
        ...
        <div class="product-con ">
            ...
            <?php $__currentLoopData = app('product_category_repository')->where('parent_id',0)->orderBy('order','desc')->orderBy('id','asc')->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key == 0): ?>
			<div class="product-item col-lg-3 col-md-3 col-sm-6 col-xs-6 wow bounceIn animated" data-wow-duration=".6s" data-wow-delay=".5s">
                <div class="product-item-box">
                    <a href="<?php echo e(route('pc.product.index',['product_category_id' => $category->id])); ?>">
                        <div class="img"><img  class="transition500" src="<?php echo theme_asset('images/p2.png'); ?>" alt=""></div>
                        <p class="transition500 fb-overflow-2"><?php echo e($category->name); ?></p>
                    </a>
                </div>
            </div>
            <?php elseif($key == 1): ?>
...
<div class="branch">
    <div class="container w1400">
        ...
        <div class="branch-con">
            <?php $__currentLoopData = app('subsidiary_repository')->orderBy('order','desc')->orderBy('id','asc')->limit(8)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subsidiary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="branch-item col-lg-3 col-md-3 col-sm-6 col-xs-6 wow bounceIn animated" data-wow-duration=".6s" data-wow-delay=".4s">
                <a href="<?php echo e(route('pc.subsidiary.show',['id' => $subsidiary->id])); ?>">
                    <div class="img"><img class="transition500" src="<?php echo e(url('image/original'.$subsidiary->image)); ?>" alt="<?php echo e($subsidiary->name); ?>"></div>
					<p class="transition500"><?php echo e($subsidiary->name); ?></p>
                </a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<div class="new">
    <div class="container w1400">
        ...
        <div class="new-con clearfix">
            <?php $__currentLoopData = app('page_repository')->where('category_id',1)->where('home_recommend',1)->orderBy('created_at','desc')->limit(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key == 0): ?>
                <div class="new-left col-lg-6 col-md-6 col-sm-12 col-xs-12  wow fadeInUp animated" data-wow-duration=".6s" data-wow-delay=".4s">
                    <div class="new-big-item transition500">
                        <a href="<?php echo e(route('pc.news.show',$news->id)); ?>">
                            <div class="img"><img class="transition500" src="<?php echo $news->image_url; ?>" alt=""></div>
                            <div class="test">
                                <div class="title fb-overflow-2 transition500"><?php echo e($news->title); ?></div>
                                <div class="des">
                                    <div class="date"><?php echo e($news->created_at->format('Y-m-d')); ?></div>
                    ...
                    <div class="new-item transition500 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <a href="<?php echo e(route('pc.news.show',$news->id)); ?>">
                            ...
                            <div class="title transition500 ">
								<div class="t-name  fb-overflow-2"><?php echo e($news->title); ?></div>
							</div>
